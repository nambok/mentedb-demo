    ...
    try {
      ...
      const raw = await callBedrock(
        [
          ...
          "HARD RULES:",
          "- If the user is TELLING you something, acknowledge that specific fact naturally (it",
          "  is being saved right now) and, when a remembered fact below relates to it, connect",
          "  the two. Do NOT say you have not learned it; they just told you.",
          "- If the user is ASKING something, answer only from the remembered facts, quoting",
          "  their real values verbatim. Only when they ask for a fact genuinely absent below",
          "  may you say you have not learned it yet.",
          "- NEVER guess, NEVER fabricate, NEVER write placeholder text or brackets.",
          "- Older corrected values are replaced, not kept: if asked for a previous value that",
          "  is not below, say you keep only the corrected version and give the current one.",
